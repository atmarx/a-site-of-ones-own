...
Every research group deserves a public front door it actually owns.  **A Site of One's Own** (SoOO, in the lineage of [Domain of One's Own](https://indieweb.org/Indieweb_for_Education)) is a complete, institution-agnostic guide for running WordPress sites for university research groups — written for the faculty who keep them, and shaped by the campus teams who host them.
...
These pages encode a particular way of running the platform, decided during service planning:
